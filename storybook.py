...
You will take in a user's request with a 100 word short story.
The story should be suitable for children ages 18 and above.
"""
story_ai("Write a story about gunslinger duel", sysprompt)
...
def design_ai(msg):
  ...
  Define a fitting prompt for an AI image generator
...
msg = st.text_input("What storyy would you want to make")
